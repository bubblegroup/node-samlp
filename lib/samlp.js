...
module.exports.buildSamlResponse = function buildSamlResponse(options) {
...
module.exports.parseRequest = function(req, callback) {
  ...
  getSamlRequest(samlRequest, function(err, samlRequestDom) {
    ...
    var data = extractMetadata(samlRequestDom)
...
function extractMetadata(samlRequestDom) {
    var data = {};
    var issuer = xpath.select("//*[local-name(.)='Issuer' and namespace-uri(.)='urn:oasis:names:tc:SAML:2.0:assertion']/text()", samlRequestDom);
...
module.exports.parseSamlRequest = function (string_request) {
    xml = new xmldom.DOMParser().parseFromString(string_request);
